...
import java.util.*
    ...
    class FEMusicPlayersImpls : FEMusicPlayers {

        private var mMusicPlayer = SimpleExoPlayer.Builder(FEMainApp.getContext()).build()
        ...
        override fun getOutMusic(): MusicReturn {
            return MusicReturn(mAudioPath, "",mStartOffset, mLength)
        }
