package com.thn.videoconstruction.fe_slide_theme
...
class FEThemeSlideDrawer(var theme: Theme) : SurfaceTexture.OnFrameAvailableListener {
    ...
    fun changeTheme(theme: Theme) {
        if (this.theme.themeVideoFilePath != theme.themeVideoFilePath) {
            ...
            this.theme = theme
            mPlayer?.release()
            if (this.theme.themeVideoFilePath != "none")
                prepare()
        }
