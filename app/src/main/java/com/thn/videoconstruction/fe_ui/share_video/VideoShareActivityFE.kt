package com.thn.videoconstruction.fe_ui.share_video
...
import com.thn.videoconstruction.modules.fe_share.Share
...
class VideoShareActivityFE : FEBaseActivity() {
    ...
    companion object {
        fun gotoActivity(
            ...
            val intent = Intent(activity, VideoShareActivityFE::class.java)
    ...
    override fun initActions() {
        setRightButton(R.drawable.ic_home_white) {
            val intent = Intent(this, HomeActivityFE::class.java).apply {
    ...
    private fun initVideoPlayer(path: String) {
        mPlayer = SimpleExoPlayer.Builder(FEMainApp.getContext()).build()
        exoPlayerView.player = mPlayer
        val bandwidthMeter = DefaultBandwidthMeter.Builder(FEMainApp.getContext()).build()
