...
class FEEditTextSticker(context: Context, attrs: AttributeSet?) : AppCompatEditText(context, attrs) {
    ...
    var editCallback: ((FEEditTextSticker) -> Unit)? = null
    ...
    init {
        ...
        addTextChangedListener(object : TextWatcher {
            ...
            override fun onTextChanged(s: CharSequence?, start: Int, before: Int, count: Int) {
                ...
                Loggers.e("text length = ${s.toString().length}")
                calculatorLineText()
            }
    ...
    fun getTextAttrData(): TextStickerAttr {
        return TextStickerAttr(mMainText, mTextColor, mFontId, mAlignMode, mTextStyle, mFlag)
    }

    fun setAttr(textStickerAttrData: TextStickerAttr) {
